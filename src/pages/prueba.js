  ...
  return (
    ...
    <header className="bg-gradient-to-b from-red-600 to-red-700 text-white">
      <div className="container mx-auto flex justify-between items-center py-1">
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-0 right-0 bg-gray-900 w-full">
                ...
                {isOpen && categories.length > 0 ?
                    ...
                    <li key={category.id}>
                        <Link 
                            ...
                            legacyBehavior
                            >
                            <a href="#" className="text-yellow-400 font-bold hover:text-gray-400">
                ...
                <div
                    ...
                    {categories?.map(category =>( 
                        <Link 
                            ...
                            legacyBehavior
                            >
                            <a href="#" className="flex  text-white items-center px-6 py-3 hover:bg-gray-100 transition">
